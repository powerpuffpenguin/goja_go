...
var bytes = __importStar(require("stdgo/bytes"));
var time = __importStar(require("stdgo/time"));
function main(c) {
    return __awaiter(this, void 0, void 0, function () {
        var data, i, msg, b, read;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    data = builtin.Uint8Slice(1024);
                    i = 0;
                    _a.label = 1;
                case 1:
                    if (!(i < 5)) return [3 /*break*/, 7];
                    if (!(i != 0)) return [3 /*break*/, 3];
                    return [4 /*yield*/, builtin.async(time.Sleep, time.Second)];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
                    ...
                    b = bytes.Bytes(msg);
                    return [4 /*yield*/, builtin.async(c.Write, b)];
                case 4:
                    _a.sent();
                    console.log("send->", msg);
                    read = data.Slice2(0, msg.length);
                    return [4 /*yield*/, builtin.async(io.ReadAtLeast, c, read, read.Len())];
                case 5:
                    _a.sent();
...
var addr = "127.0.0.1:10000";
builtin.async(net.Dial, 'tcp', addr).then(function (c) {
    main(c).catch(function (e) {
